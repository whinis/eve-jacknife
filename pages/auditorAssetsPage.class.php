...
function item_display($station, $itemId, $item, &$allItems, $lvl = 0)
{
    ...
    Items in the AssetList (and ContractItems) now include a rawQuantity attribute if the quantity in the
    DB is negative. Negative quantities are in fact codes, -1 indicates that the item is a singleton (non-stackable).
    If the item happens to be a Blueprint, -1 is an Original and -2 is a Blueprint Copy. For further information about
    negative quantities see this devblog: http://www.eveonline.com/devblog.asp?a=blog&nbid=2324
    */
